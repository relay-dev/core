namespace Core.FileHandling
{
    ...
    {
        /// <summary>
        /// Creates a file and stores it in a location to be determined by the concrete implementations of IFileSystem
        /// </summary>
        ...
        /// <summary>
        /// Gets a file from a location to be determined by the concrete implementations of IFileSystem
        /// </summary>
